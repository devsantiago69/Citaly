  ...
  try {
    ...
    const formattedResults = results.map(cita => ({
      ...
      cliente: {
        ...
        service: {
          id: cita.servicio_id,
          name: cita.servicio_nombre,
          duration: cita.servicio_duracion,
          price: cita.servicio_precio,
          category: cita.categoria_nombre
        },
        staff: cita.personal_id ? {
          id: cita.personal_id,
          name: cita.personal_nombre
        } : null,
        notes: cita.notas
      }));
